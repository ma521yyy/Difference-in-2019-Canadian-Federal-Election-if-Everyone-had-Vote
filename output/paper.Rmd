...
${\beta}_{4}$ coefficient represents the change in log odds for respondent who is born in Canada,  
...
```
Errors exists in the code for getting vote outcome. To be fixed.
