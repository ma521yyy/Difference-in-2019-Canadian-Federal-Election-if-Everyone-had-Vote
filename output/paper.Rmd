---
title: "Difference in 2019 Canadian Federal Election if Everyone had Voted"
author: "Qiyue Zhang"
...
By the pie plot of province and age groups according to Figure 11 and 12, we can see people ten provinces and five age groups equally split the entire population in the census dataset, which means people from every provinces and every age groups are well represented in the final vote outcome result.
...
kable(together, digits=4, 
      caption="Vote Outcome for the Conservative Party of 2019 Canadian Federal Election if Everyone had Voted")
...
kable(geography, digits=4, 
      caption="Vote Outcome for the Conservative Party of 2019 Canadian Federal Election if Everyone had Voted by Province")
